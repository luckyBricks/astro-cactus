...
Following is an example blog post written in an md file. You can find me @ src/pages/posts/hello-world.md. Here you can add/uppublishDate:/delete details and watch the changes live when running in develop mode.
